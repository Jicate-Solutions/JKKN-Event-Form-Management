          ...
          <CardHeader>
            ...
            {form.submission_limit && submissionCount !== null && (
              <div className='mt-4'>
                    ...
                    <div className='flex items-start'>
                      ...
                      <div className='ml-3'>
                        ...
                        <div className='mt-2 text-sm text-red-700'>
                          <p>
                            This form has reached its maximum submission limit
                            of {form.submission_limit} responses. New
                ...
                ) : submissionCount >= form.submission_limit * 0.9 ? (
                    ...
                    <div className='flex items-start'>
                      ...
                      <div className='ml-3'>
                        <h3 className='text-sm font-medium text-yellow-800'>
                          Limited Submissions Remaining
                        </h3>
                        <div className='mt-2 text-sm text-yellow-700'>
                          <p>
                            {form.submission_limit - submissionCount} of{' '}
                            {form.submission_limit} submission slots remaining.
                            Submit soon as this form has limited availability.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='flex items-start'>
                      ...
                      <div className='ml-3'>
                        <h3 className='text-sm font-medium text-blue-800'>
                          Limited Submissions Available
                        </h3>
                        <div className='mt-2 text-sm text-blue-700'>
                          <p>
                            {form.submission_limit - submissionCount} of{' '}
                            {form.submission_limit} submission slots available.
                          </p>
                        </div>
                      </div>
                    </div>
